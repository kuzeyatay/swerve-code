...
/*
 * Class for auto alining april tags
 */
...
public class ApriltagAutoAlign extends Command {
  ...
  private static final Transform3d TAG_TO_GOAL =
      new Transform3d(
          new Translation3d(0.70, 0.0, 0.0), new Rotation3d(0.0, 0.0, Math.PI)); //  0.70 meters
  // infront of it
  ...
  /** Aligns 0.5 meter infront of the given tag */
  public ApriltagAutoAlign(
  ...
  public void execute() {
    ...
    if (photonRes.hasTargets()) {
      ...
      if (targetOpt.isPresent()) {
        ...
        var cameraPose = robotPose.transformBy(VisionConstants.kRobotToCam);
